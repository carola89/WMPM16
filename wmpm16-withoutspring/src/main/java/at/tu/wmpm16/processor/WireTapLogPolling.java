...
@Service
public class WireTapLogPolling implements Processor{
	
	 Logger logger = LoggerFactory.getLogger(WireTapLogPolling.class);

	@Override
	public void process(Exchange exchange) throws Exception {
		
		String date = new SimpleDateFormat("dd/MM/yyyy @ HH:mm:ss").format(Calendar.getInstance().getTime());
		logger.info("Polling Consumer WireTap: "+date.toString());
