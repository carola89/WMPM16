...
public class WarmWaterConsumptionMailToDbProcessor implements Processor{

	Logger logger = LoggerFactory.getLogger(WarmWaterConsumptionMailToDbProcessor.class);
	...
	public void process(Exchange exchange) throws Exception {
        ...
        for (List<String> line : data) {
       	 if(i!=0){
                 WarmWaterConsumption c = new WarmWaterConsumption();
