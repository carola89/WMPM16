...
public class ElectricityConsumptionMailToDbProcessor implements Processor{

	Logger logger = LoggerFactory.getLogger(ElectricityConsumptionMailToDbProcessor.class);
	...
	public void process(Exchange exchange) throws Exception {
        ...
        for (List<String> line : data) {
       	 if(i!=0){
                 ElectricityConsumption c = new ElectricityConsumption();
                 ...
                 c.setSmartMeterNr(Integer.parseInt(line.get(4)));   
