...
public class ColdWaterConsumptionMailToDbProcessor implements Processor{

	Logger logger = LoggerFactory.getLogger(ColdWaterConsumptionMailToDbProcessor.class);
	...
	public void process(Exchange exchange) throws Exception {
        ...
        for (List<String> line : data) {
       	 if(i!=0){
                 ColdWaterConsumption c = new ColdWaterConsumption();
