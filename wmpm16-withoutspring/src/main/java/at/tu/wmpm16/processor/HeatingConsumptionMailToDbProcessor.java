...
public class HeatingConsumptionMailToDbProcessor implements Processor{

	Logger logger = LoggerFactory.getLogger(HeatingConsumptionMailToDbProcessor.class);
	...
	public void process(Exchange exchange) throws Exception {
        ...
        for (List<String> line : data) {
       	 	if(i!=0){
                HeatingConsumption c = new HeatingConsumption();
